...
class PendidikanController extends Controller {
  ...
  public function store(Request $request, string $username) {
    try {
      ...
      return to_route('pelamar.pendidikan.index', $username)->with('sukses', 'Berhasil menambahkan riwayat pendidikan baru');
    } catch (\Exception $e) {
      return to_route('pelamar.pendidikan.index', $username)->with('error', $e->getMessage());
    }
  }
}
