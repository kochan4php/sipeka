    ...
    <div class="col">
      <div class="card">
        ...
        <div class="card-body pb-0">
          ...
          <form
            action="{{ route('penilaian.seleksi.update', [
                'pendaftaran_lowongan' => $pendaftaranLowongan->id_pendaftaran,
                'penilaian_seleksi' => $penilaianSeleksi->id_penilaian_seleksi,
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-8">
                <input type="number" max="100" min="1"
                  ...
                  value="{{ old('nilai', $penilaianSeleksi->nilai) }}">
              </div>
            </div>
            <div class="mb-3 row">
              ...
              <div class="col-sm-8">
                <select name="keterangan" class="form-control" id="keterangan">
                  ...
                  <option value="Lulus" @selected($penilaianSeleksi->keterangan === 'Lulus')>
                    Lulus
                  </option>
                  <option value="Gagal" @selected($penilaianSeleksi->keterangan === 'Gagal')>
                    Gagal
                  </option>
                </select>
              </div>
              ...
              <div class="col-sm-8">
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="is_lanjut" id="Ya" value="Ya"
                    {{ $penilaianSeleksi->is_lanjut === 'Ya' ? 'checked' : '' }}>
                ...
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="is_lanjut" id="Tidak" value="Tidak"
                    {{ $penilaianSeleksi->is_lanjut === 'Tidak' ? 'checked' : '' }}>
