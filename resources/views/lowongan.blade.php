                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <img src="{{ $lowonganKerja->banner ? $lowonganKerja->banner : asset('assets/images/no-photo.png') }}"
                                class="img-fluid w-100 rounded" alt="{{ $lowonganKerja->perusahaan->nama_perusahaan }}"
                                draggable="false">
                        </div>
                                            ...
                                            <div class="card">
                                                <div class="card-body pb-0">
                                                    ...
                                                    <div class="my-2">
                                                        ...
                                                        <p class="text-break" style="font-size: 16px;">
                                                            {{ $item->ket_tahapan }}</p>
                                                    </div>
                                                </div>
                                    ...
                                    @forelse ($lowongan as $item)
                                        <div class="card">
                                            <div class="card-body table-responsive d-flex gap-3">
                                                <div>
                                                    <img src="{{ $item->perusahaan->logo_perusahaan ? asset('storage/' . $item->perusahaan->logo_perusahaan) : asset('assets/images/no-photo.png') }}"
                                                ...
                                                <div class="my-auto">
                                                    <a class="text-decoration-none text-black font-bolder stretched-link"
                                                        ...
                                                        <h4 class="fw-bold">
                                                            {{ \Illuminate\Support\Str::limit($item->judul_lowongan, 20) }}
                                                        </h4>
                                                    </a>
                                                    <p class="card-text">
                                                        <span
                                                            class="fw-semibold fst-italic">{{ $item->perusahaan->nama_perusahaan }}</span>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                ...
                <form action="{{ route('lowongan.apply', $lowonganKerja->slug) }}" method="post"
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="surat_lamaran_kerja"
                    ...
                    <div class="modal-footer">
                        <button type="button" class="custom-btn btn btn-secondary"
