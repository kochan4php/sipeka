                ...
                <table class="table table-bordered border-secondary table-striped py-2">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th scope="col" class="text-nowrap text-center vertical-align-middle custom-font">Kode
                                Jurusan</th>
                            <th scope="col" class="text-nowrap text-center vertical-align-middle custom-font">Nama
                                Jurusan</th>
                            <th scope="col" class="text-nowrap text-center vertical-align-middle custom-font">Keterangan
                                Jurusan</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-modal-edit" method="post">
                        ...
                        @method('put')
                        <div class="mb-3 row">
                            <label for="kode_jurusan_edit"
                                class="col-sm-4 text-nowrap col-form-label text-md-end fs-6 fs-md-5">
                                {{ __('Kode Jurusan') }}
                            </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="kode_jurusan_edit" name="kode_jurusan"
                                    readonly style="cursor: not-allowed" value="JRS0006">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="nama_jurusan_edit"
                                class="col-sm-4 text-nowrap col-form-label text-md-end fs-6 fs-md-5">
                                {{ __('Nama Jurusan') }}
                            </label>
                            <div class="col-sm-8">
                        ...
                        <div class="mb-3 row">
                            <label for="keterangan_jurusan_edit"
                                class="col-sm-4 text-nowrap col-form-label text-md-end fs-6 fs-md-5">
                                {{ __('Keterangan') }}
                            </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="keterangan_jurusan_edit"
                                    name="keterangan_jurusan" placeholder="Rekayasa Perangkat Lunak">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <div class="col-sm-4"></div>
