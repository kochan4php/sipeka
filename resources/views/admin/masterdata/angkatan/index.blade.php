                    ...
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th scope="col" class="text-nowrap text-center vertical-align-middle custom-font">Kode
                                Angkatan</th>
                            <th scope="col" class="text-nowrap text-center vertical-align-middle custom-font">Tahun
                                Angkatan</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-modal-edit" method="post">
                        ...
                        <div class="mb-3 row">
                            <label for="angkatan_tahun_edit"
                                class="col-sm-4 text-nowrap col-form-label text-md-end fs-6 fs-md-5">
                                {{ __('Tahun Angkatan') }}
                            </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="angkatan_tahun_edit"
                                    name="angkatan_tahun" placeholder="2021/2022" value="2021/2022">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <div class="col-sm-4"></div>
