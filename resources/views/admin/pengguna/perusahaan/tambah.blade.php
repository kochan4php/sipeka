            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3 row">
                            <label for="password_perusahaan"
                                class="custom-font col-sm-4 col-form-label text-md-end fs-6 fs-md-5">
                                {{ __('Password Perusahaan') }}
                            </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="password_perusahaan"
                                    name="password_perusahaan" placeholder="password" value="perusahaan" readonly>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="kategori_perusahaan"
                                class="custom-font col-sm-4 col-form-label text-md-end fs-6 fs-md-5">
                        ...
                        <div class="mb-3 row">
                            <label for="no_telepon_perusahaan"
                                class="custom-font col-sm-4 col-form-label text-md-end fs-6 fs-md-5">
                                {{ __('No. Telepon Perusahaan') }}
                            </label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control" id="no_telepon_perusahaan"
                                    name="no_telepon_perusahaan" placeholder="08988928239"
                                    value="{{ old('no_telepon_perusahaan') }}">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="foto_sampul_perusahaan"
                                class="custom-font col-sm-4 col-form-label text-md-end fs-6 fs-md-5">
                                {{ __('Foto Sampul Perusahaan') }}
                            </label>
                            <div class="col-sm-8">
                                <input type="file" class="form-control" id="foto_sampul_perusahaan"
                                    name="foto_sampul_perusahaan">
                            </div>
                        </div>
                        <div class="mb-3 row">
