                        ...
                        <div class="col">
                            <div class="d-flex align-items-center justify-content-center">
                                @if (is_null($perusahaan->foto_sampul_perusahaan))
                                    <img src="{{ asset('assets/images/no-photo.png') }}" class="img-fluid"
                                        alt="Foto Sampul Perusahaan" draggable="false" width="600">
                                @else
                                    <img src="{{ asset('storage/' . $perusahaan->foto_sampul_perusahaan) }}"
                                        alt="{{ $perusahaan->username }}" class="img-fluid" width="600"
                                        draggable="false">
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 text-center mb-4 mb-lg-0">
                            <div class="d-flex justify-content-center">
                                @if (is_null($perusahaan->logo_perusahaan))
                                    <img src="{{ Avatar::create($perusahaan->user->email)->toGravatar(['d' => 'identicon', 'r' => 'pg', 's' => 1000]) }}"
                                        alt="{{ $perusahaan->user->username }}"
                                        class="rounded-circle border border-secondary" width="170" draggable="false">
                                @else
