                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="email" class="form-control" id="email_perusahaan" name="email_perusahaan"
                                    ...
                                    value="{{ old('email_perusahaan', $perusahaan->user->email) }}">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <select name="kategori_perusahaan" id="kategori_perusahaan" class="form-select" required>
                                    ...
                                    @foreach ($kategori as $item)
                                        <option value="{{ $item }}" @selected($item == $perusahaan->kategori_perusahaan)>{{ $item }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" id="no_telepon_perusahaan"
                                    name="no_telepon_perusahaan" placeholder="(021)9987653"
