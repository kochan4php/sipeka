                    ...
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th scope="col" class="text-nowrap text-center vertical-align-middle custom-font">Nama
                                Lengkap</th>
                            <th scope="col" class="text-nowrap text-center vertical-align-middle custom-font">Username
                            </th>
                            <th scope="col" class="text-nowrap text-center vertical-align-middle custom-font">No. Telepon
                            </th>
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap text-center vertical-align-middle custom-font">
                                    <div class="d-flex gap-2 align-items-center justify-content-center">
                                        ...
                                        <form action="{{ route('admin.pelamar.deactive', $item->username) }}"
                                            method="post">
                                            @csrf
                                            @method('put')
