...
<body>
  <header class="navbar navbar-dark sticky-top bg-info flex-md-nowrap p-0">
    <a class="navbar-brand bg-info col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">Company name</a>
