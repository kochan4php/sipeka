                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="posisi" name="posisi"
                                    placeholder="Programmer" required value="{{ old('posisi', $lowongan->posisi) }}">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="estimasi_gaji" name="estimasi_gaji"
                                    ...
                                    value="{{ old('estimasi_gaji', $lowongan->estimasi_gaji) }}">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <select name="jenis_pekerjaan" id="jenis_pekerjaan" class="form-select jenis_pekerjaan"
                                    required>
