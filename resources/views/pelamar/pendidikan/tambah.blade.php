          ...
          <div class="card-body">
            <div class="row">
              <div class="col-sm-12">
                ...
                <form action="{{ route('pelamar.pendidikan.store', Auth::user()->username) }}" method="POST">
                  @csrf
                  <div class="mb-3 row">
                    <label for="institut_or_universitas" class="col-sm-4 col-form-label text-md-end fs-6 fs-md-5">
                  ...
                  <div class="mb-3 row">
                    <label for="tahun_kelulusan" class="col-sm-4 col-form-label text-md-end fs-6 fs-md-5">
                      {{ __('Tahun Kelulusan') }}
                    </label>
                    <div class="col-sm-8 d-flex gap-2">
                      ...
                      <input type="text" class="form-control" id="tahun" name="tahun" placeholder="2022"
                        required>
                    </div>
                  </div>
                  <div class="mb-3 row">
                  ...
                  <div class="mb-3 row">
                    <label for="informasi_tambahan" class="col-sm-4 col-form-label text-md-end fs-6 fs-md-5">
