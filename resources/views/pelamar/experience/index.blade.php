            ...
            <div class="col-lg-9">
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('pelamar.experience.add', Auth::user()->username) }}"
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    ...
                                                    <div class="d-flex gap-2">
                                                        <p>{{ \Carbon\Carbon::parse($pk->tanggal_masuk)->format('d M Y') }}
                                                        </p>
                                                        <span>-</span>
                                                        <p>{{ \Carbon\Carbon::parse($pk->tanggal_selesai)->format('d M Y') }}
                                                        </p>
                                                    </div>
                                                    <p>Indonesia</p>
                                                </div>
