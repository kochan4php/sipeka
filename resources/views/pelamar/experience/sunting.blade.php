                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="judul_posisi" name="judul_posisi"
                                                ...
                                                value="{{ $pengalamanKerja->judul_posisi }}">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="nama_perusahaan"
                                                name="nama_perusahaan" placeholder="PT. Tokopedia Indonesia" required
                                                value="{{ $pengalamanKerja->nama_perusahaan }}">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label for="id_jenis_pekerjaan"
                                            class="col-sm-4 col-form-label text-md-end fs-6 fs-md-5">
                                            {{ __('Jenis Pekerjaan') }}
                                        </label>
                                        <div class="col-sm-8">
                                            <select name="id_jenis_pekerjaan" id="id_jenis_pekerjaan" class="form-select"
                                                required>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date" class="form-control" id="tanggal_masuk"
                                                name="tanggal_masuk" value="{{ $pengalamanKerja->tanggal_masuk }}">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date" class="form-control" id="tanggal_selesai"
                                                name="tanggal_selesai" value="{{ $pengalamanKerja->tanggal_selesai }}">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label for="deskripsi_pengalaman"
                                            class="col-sm-4 col-form-label text-md-end fs-6 fs-md-5">
