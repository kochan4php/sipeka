                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="username" name="username"
                                        placeholder="202115908" required
                                        value="{{ old('username', $data->pelamar->user->username) }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" class="form-control" id="nis" name="nis"
                                        placeholder="202115908" required value="{{ old('nis', $data->nis) }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-8">
                                    <select name="jenis_kelamin" id="jenis_kelamin" class="form-select" required>
                                        ...
                                        <option value="L" @if ($data->jenis_kelamin === 'L') @selected(true) @endif>
                                            Laki-laki</option>
                                        <option value="P" @if ($data->jenis_kelamin === 'P') @selected(true) @endif>
                                            Perempuan</option>
                                    </select>
                                </div>
                            </div>
                                    ...
                                    <select name="id_jurusan" id="id_jurusan" class="form-select" required>
                                        ...
                                        @foreach ($jurusan as $item)
                                            <option value="{{ $item->id_jurusan }}"
                                                @if ($item->id_jurusan === $data->jurusan->id_jurusan) @selected(true) @endif>
                                                {{ $item->nama_jurusan }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="id_angkatan" id="id_angkatan" class="form-select" required>
                                        ...
                                        @foreach ($angkatan as $item)
                                            <option value="{{ $item->id_angkatan }}"
                                                @if ($item->id_angkatan === $data->angkatan->id_angkatan) @selected(true) @endif>
                                                {{ $item->angkatan_tahun }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir"
                                        placeholder="Bekasi" value="{{ old('tempat_lahir', $data->tempat_lahir) }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" class="form-control" id="no_telepon" name="no_telepon"
                                        placeholder="08988976056" value="{{ old('no_telepon', $data->no_telepon) }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
