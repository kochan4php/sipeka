        ...
        <div class="card-body">
          ...
          <form action="{{ route('admin.alumni.store') }}" method="POST">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" id="deskripsi" name="deskripsi" placeholder="Lulusan D3/S1"
                  required>
              </div>
            </div>
            <div class="mb-3 row">
              <label for="tanggal_mulai" class="col-sm-4 col-form-label text-md-end fs-6 fs-md-5">
                {{ __('Tanggal Dimulai') }}
              </label>
              <div class="col-sm-8">
                <select name="tanggal_mulai" id="tanggal_mulai" class="form-select" required>
