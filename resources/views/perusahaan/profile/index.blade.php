                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col d-flex align-items-center justify-content-center">
                            ...
                            @else
                                <img src="{{ asset('storage/' . $mitra->foto_sampul_perusahaan) }}"
                                    alt="{{ $mitra->username }}" class="img-fluid" width="600" draggable="false">
                            @endif
                        </div>
                    </div>
                    <hr />
                    <div class="row my-4">
                        <div class="col-lg-3 text-center mb-4 mb-lg-0 d-flex align-items-center justify-content-center">
                            @if (is_null($mitra->logo_perusahaan))
                                <img src="{{ Avatar::create($mitra->user->email)->toGravatar(['d' => 'identicon', 'r' => 'pg', 's' => 1000]) }}"
                                    alt="{{ $mitra->username }}" class="rounded-circle border border-secondary"
                                    width="170" draggable="false">
                            @else
                                <img src="{{ asset('storage/' . $mitra->logo_perusahaan) }}" alt="{{ $mitra->username }}"
                                    width="170" draggable="false">
                            @endif
                        </div>
                        <div class="col-lg-9">
                ...
                <div class="card-body pb-0">
                    ...
                    <form action="{{ route('perusahaan.profile.index') }}" method="POST">
                        ...
                        <div class="mb-3 row custom-font">
                            ...
                            <div class="col-sm-8">
                                <input type="email" class="form-control" id="email_perusahaan" name="email_perusahaan"
                                    placeholder="Bangun Kreatif Abadi" required
                                    value="{{ old('email_perusahaan', $mitra->user->email) }}" autocomplete="off">
                            </div>
                        </div>
                        <div class="mb-3 row custom-font">
                            <label for="nis" class="col-sm-4 col-form-label text-md-end">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="username_perusahaan"
                                    name="username_perusahaan" placeholder="bangun-kreatif-abadi" required
                            ...
                            <div class="col-sm-8">
                                <select name="kategori_perusahaan" id="kategori_perusahaan" class="form-select" required
                                    ...
                                    @foreach ($kategori as $item)
                                        <option value="{{ $item }}" @selected($item === $mitra->kategori_perusahaan)>
                                            {{ $item }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="mb-3 row custom-font">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="nomor_telp_perusahaan"
                                    name="nomor_telp_perusahaan" placeholder="089889287463" required
