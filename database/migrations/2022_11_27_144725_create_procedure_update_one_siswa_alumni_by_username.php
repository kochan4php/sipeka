      ...
      BEGIN
        ...
        IF (foto IS NOT NULL) THEN
          UPDATE siswa_alumni
            INNER JOIN pelamar ON siswa_alumni.id_pelamar = pelamar.id_pelamar
            INNER JOIN users ON pelamar.id_user = users.id_user
            SET siswa_alumni.foto = foto WHERE users.id_user = id_user;
        END IF;
